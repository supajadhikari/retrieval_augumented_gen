...
Then we have to install some packages : langchain, python-dotenv, streamlit, pypdf2, openai , langchain-classic, langchain-openai, langchain-community, faiss-cpu: 
